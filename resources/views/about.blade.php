...
<body>
	...
	<section class="team">
		...
		<div class="team-cards">
			...
			<div class="card">
				<div class="card-img">
					<img src="https://media.geeksforgeeks.org/wp-content/uploads/20230824122630/
business-office-business-woman-professional.jpg" alt="User 1">
			...
			<div class="card">
				<div class="card-img">
					<img src="https://media.geeksforgeeks.org/wp-content/uploads/20230822183347/
...
<style>
	* {
	...
	/* About Section */
	.about {
		background: rgb(19, 192, 232);
		background: linear-gradient(90deg, rgba(19, 192, 232, 1) 0%, rgba(1, 134, 255, 1) 100%, rgba(0, 212, 255, 1) 100%);
